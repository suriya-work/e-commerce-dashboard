...
const Profile = () => {
  return (
    <div className="flex items-center justify-center gap-5 cursor-pointer">
      <div className="relative bg-mainfg rounded-full w-8 h-8 hover:bg-mainbg">
      ...
      <div className="flex items-center justify-center bg-mainfg rounded-full w-8 h-8 hover:bg-mainbg">
